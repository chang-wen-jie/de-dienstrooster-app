        ...
        @foreach($present_users as $present_user)
            <tr>
                ...
                <td class="text-center">
                    <a href="{{ route('users.update', $present_user->id) }}" class="btn btn-primary btn-sm">
                        Zet op afwezig
                    </a>
                </td>
            </tr>
    ...
    <table class="table" style="background-color: red">
        ...
        @foreach($absent_users as $absent_user)
            <tr>
                ...
                <td>{{$absent_user->latest_check_in}}</td>
                <td>{{$absent_user->latest_check_out}}</td>
                <td class="text-center">
                    <a href="{{ route('users.update', $absent_user->id) }}" class="btn btn-primary btn-sm">
                        Zet op aanwezig
                    </a>
                </td>
            </tr>
